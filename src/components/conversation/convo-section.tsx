...
export const ConvoSection = () => {
  ...
  return (
    <motion.div 
      className="bg-[#fff352] py-10 md:py-20 px-4 sm:px-10"
    ...
    >
      <div className="flex flex-col md:flex-row text-[#1B1B1B] justify-center items-center gap-8 md:gap-12">
        ...
        >
          ...
          <motion.div className="hidden lg:flex flex-col gap-4 self-center md:self-end md:mb-16" variants={imageVariants}>
            <Image
